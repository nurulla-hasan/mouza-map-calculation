...
const PrintLayout = React.forwardRef(({ results, reportImage, imageName }, ref) => {
  ...
  return (
    <div ref={ref} className="hidden print:block p-8 font-sans">
      ...
      <div className="mb-8 break-inside-avoid">
        <h2 className="text-xl font-semibold mb-2 border-b pb-1">বাহুর দৈর্ঘ্য সমূহ</h2>
        <SideLengthsList lengths={results.lengths} />
      </div>
      <div className="break-inside-avoid">
        <h2 className="text-xl font-semibold mb-2 border-b pb-1">প্লট সহ ম্যাপ</h2>
        <img src={reportImage} alt="গণনা করা প্লট" className="w-full border border-border rounded-md" />
      </div>
